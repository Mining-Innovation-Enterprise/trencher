# -*- coding: utf-8 -*-
"""Zack_workingbuttontest.py

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1O8wHnhyfPdutn7D7vTTr4wIsLny_SybZ
"""

'''
All I need is for the code to check if the value is between two frequencies in a list, and set it to the lower of the frequencies
'''

def accel_curve(value, motor):
    #gantry_freq = 0

    avail_freq = [80,100,125,200,250]
    if motor == 'x':
...
def accel_curve(value, motor):
    ...
    if motor == 'x':
        ...
        if (value in avail_freq):
            gantry_freq = avail_freq[avail_freq.index(value)]
            n = avail_freq.index(gantry_freq)
            print(n)
            return gantry_freq
...
while run:
  i+=1
  x_fr = accel_curve(i,'x')
  if (i==1) | (i==100) | (i==124) |(i==199) | (i==270):
    print(f'The current Frequency is {x_fr}: count = {i}')
  if  i>=2600:
    run = False
