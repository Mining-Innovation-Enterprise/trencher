...
while True:
   ...
   # pi.set_PWM_dutycycle(12,duty)
    ...
    if pi.read(x_plus) == 0: # drives the gantry clockwise
        ...
        pi.set_PWM_frequency(x_step, 1250) # default 1000
    ...
    if pi.read(t_plus) == 0:
       ...
       # pi.set_PWM_dutycycle(12, duty)
        ...
        pi.write(22, 1)
        speed = 500
        duty = 500000  # 128 is half, 255 is full
       # pi.set_PWM_frequency(12, speed)
       # pi.set_PWM_dutycycle(12, duty)
        pi.hardware_PWM(12,speed,duty)
        pi.write(fr, 0)
